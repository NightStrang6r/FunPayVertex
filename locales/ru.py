...
💬 <b><i>Telegram чат:</i></b> @funpayplace
🧩 <b><i>Плагины:</i></b> @funpayplace
👨‍💻 <b><i>Разработчик:</i></b> NightStrang6r"""
...
<i>Плагины:</i> @funpayplace
<i>Разработчик:</i> NightStrang6r"""
...
pl_new = "Отправь мне плагин.\n\n<b>⚠️ ВНИМАНИЕ! Загрузка плагинов из сомнительных источников может привести к печальным последствиям.\n" \
         "@funpayplace решает большинство возможных проблем.</b>"

au_user_settings = "Настройки для пользователя {}"
adv_fpv = "😎 FunPay Vertex - лучший бот для FunPay"
...
🛠️ Создать своего бота: github.com/NightStrang6r/FunPayVertex
🧩 Плагины: @funpayplace
💬 Чат: @funpayplace"""
